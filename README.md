...
`/server`: The serverside which calls the Hypixel API. ~~This is what's running on my server at `https://gtb-tab-stats.blackilykat.dev/api`~~. This is required by the [API policy](https://developer.hypixel.net/policies/):
